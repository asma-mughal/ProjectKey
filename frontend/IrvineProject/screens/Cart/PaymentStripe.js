...
const CURRENCY = 'USD';
var CARD_TOKEN = null;
const Secret_key ='sk_test_51LYTnAHvT9S2cNmleTDo3tz5c7L9o10REYpJQpBQR82iyImoLepYMTeARDlpK7Wn40evbYHHnyRoqoasaIiaUZKY00zfSZC9WN';
const STRIPE_PUBLISHABLE_KEY ='pk_test_51LYTnAHvT9S2cNmlcPd41gZL5FKKFElFaEwADhSaNQUgOMeRIK5KDjRZIB8c2wKZMHKL2NLPlcdMvSOIM0wEyOX000RNVm5Kh4';
...
export const PaymentStripe = ({navigation}) => {
  ...
  const onSubmit = async () => {
    ...
    if (error) {
      ...
      console.log('pament_data This is ID', pament_data.id);
      if(pament_data.status == 'succeeded')
      {
        alert("Payment Successfully");
            navigation.replace('DeliveryStatus',{paymentId:pament_data.id,token:'',PayerID:''})
