...
from .models import Category, Product, Payment, Cart, Order, UserCompetitions, News, Competitions
from .serializers import CategorySerializer, ProductSerializer,PaymentSerializer, CartSerializer, OrderSerializer, UserCompetitionSerializer, NewsSerializer, CompetitionSerializer
